                         ...
                         navbarPage("Visual",
                                    ...
                                    tabPanel("WorldwideBox.Office",
                                                 ...
                                                 mainPanel(
                                                     ...
                                                     tags$i("DomesticBox.Office` is the overall profit in US and `WorldwideBox.Office is the overall profit in the world. Plot between `WorldwideBox.Office` and `DomesticwideBox.Office` are highly correlated."),
                                                     h3("Opening Weekend vs WorldwideBox.office"),
                                                     plotOutput("OpeningWeekend"),
                                                     tags$i("Opening Weekend` is the profit of opening weekend and this variable also showed higly corrleated with `WorldwideBox.office."),
                                                     h3("Month vs WorldwideBox.office"),
                                                     plotOutput("Month"),
                                                     tags$i("This is a boxplot of `WorldwideBox.Office` by `month. Movies released on May, Jun, Jul had higher `WorldwideBox.Office` comparing to the movies released in other months. "),
                                                     h3("Year vs WorldwideBox.office"),
                                                     plotOutput("Year"),
                                                     tags$i("The movies released recently showed higher `WorldwideBox.Office`. "),
                                                     h3("Genre v.s. WorldwideBox.office"),
                                                     plotOutput("Genre"),
                                                     tags$i("Among `Genre`, 'Action' and 'Adventure' have higher profits than other Genre."),
                                                     h3("Creative Type vs WorldwideBox.office"),
                                                     plotOutput("Creative_Type"),
                                                     tags$i("Among `Creative Types`, 'Super Hero' showed the highest `WorldwideBox.Office` and 'Kids Fiction' and 'Science Fiction' also showed high `WorldwideBox.Office. "),
                                                     ...
                                                     plotOutput("tGenre"),
                                                     tags$i("From 1930 to 2000, `WorldwideBox.Office` among different `Genre`s were similar, but from 2001 to 2010 and from 2011 to 2020, 'Action and 'Adventure' Genres showed significantly high in WorldwideBox.Office."),
                                                     h3("See the trend of Creative Type"),
                                                     plotOutput("tCreative_type"),
                                                     tags$i("From 1930 to 2000, 'Contemporay Fiction' showed high `WorldwideBox.Office`. From 2001 to 2010 and from 2011 to 2020, still 'Contemporary Fiction' showed high 'WorldwideBox.Office' and the other `Creative Type` also showed high `WorldwideBox.Office`.")
                                                 )
                                             ),
                                    tabPanel("",
                                             sidebarLayout(
                ...
                tabPanel("Data Analysis",
                         sidebarLayout(
                             ...
                             mainPanel(
                                 ...
                                 h3("QQplot"),
                                 plotOutput("qqplot"),
                                 tags$i("QQplot checks the normality of the residuals. The closer it looks like line, the more residuals follow the normal distribution. "),
                                 h3("bptest"),
